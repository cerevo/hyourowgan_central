 ...
 * NON-OS, RTOS
 *
 * NOTE: If an correct TICKLESS IDLE porting is not provided, the
 * TWIC_RTOS__NONOS shall be chosen even if the FreeRTOS is used.
 */
 ...
 * NOTE: Please define TWIC_BLE_HWIP_V41 if the device is TZ1041/TZ1021.
 *
 ...
 *
 */
#if defined(TZ1XXX_BOARD_EXTERIOR_A) || defined(TWIC_BLE_HWIP_V41)
