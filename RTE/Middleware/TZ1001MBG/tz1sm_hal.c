...
void tz1smHalSuppressHpd(const bool enable)
{
  ...
  /* HW FLOW is OFF. Pin is except CTS. */
#define IOMUX_UA2_CTS_N_FMODE (0)
#elif (RTE_UA2_CTS_N_ID == 1) && (RTE_GPIO_11_ID != 2)
  /* HW FLOW is ON. Pin is except CTS. */
#define IOMUX_UA2_CTS_N_FMODE (1)
#elif (RTE_UA2_CTS_N_ID != 1) && (RTE_GPIO_11_ID == 2)
  /* HW FLOW is OFF. Pin is CTS. */
#define IOMUX_UA2_CTS_N_FMODE (3)
#else
#error Conflicted IO pin in IOMUX_UA2_CTS_N_FMODE
#endif
#if TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED1 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED2 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED3 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED4 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED5
...
#endif
    /* TZ1SM_HAL_GPIO_BLE_CTS -> GPIO_11 */
#if TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED1 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED2 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED3 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED4 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED5
    tz1smHalGpioRead(TZ1SM_HAL_GPIO_BLE_CTS, &level);
#endif
    /* "!RTE_UART2_HW_FLOW" && "OUTPUT is UART_CTS" */
...
#if (TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED1 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED2 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED3 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED4 || TZ1SM_HAL_GPIO_BLE_CTS == TWIC_LED_GPIO_LED5) && (RTE_GPIO_11_ID != 2)
    Driver_GPIO.Configure(TZ1SM_HAL_GPIO_BLE_CTS, GPIO_DIRECTION_OUTPUT_2MA,
                          GPIO_EVENT_DISABLE, NULL);
    tz1smHalGpioWrite(TZ1SM_HAL_GPIO_BLE_CTS, level);
#elif (RTE_GPIO_11_ID != 2)
